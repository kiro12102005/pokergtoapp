...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    body: "履歴ページの「傾向分析」では、保存した分析結果のうち実際に選択したアクションが推奨と一致した割合を、ストリート別・ポジション別に集計します。一致率が低い項目には「練習する」リンクが表示され、その弱点をそのまま練習モードで出題できます。件数が少なすぎる項目(3件未満)は誤解を避けるため非表示になります。",
  },
  {
